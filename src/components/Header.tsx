    ...
    <>
      ...
      {menuOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-95 flex flex-col pt-[72px] z-40 lg:hidden border-t-4 border-black shadow-lg h-screen w-full">
          ...
          <Link href="/about" className="py-2 text-white font-[200px] text-[22px] hover:text-pink-400 w-full text-left ml-5" onClick={() => setMenuOpen(false)}>Login /Sign up</Link>
          ...
          <Link href="/events" className="py-2 text-white font-[200px] text-[22px] hover:text-pink-400 w-full text-left ml-5" onClick={() => setMenuOpen(false)}>Upcoming Events</Link>
